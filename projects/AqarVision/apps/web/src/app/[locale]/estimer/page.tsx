    ...
    <main className="min-h-screen bg-[#f7fafc]">
      <div className="mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="mb-10 text-center">
          ...
          <h1 className="mt-4 text-3xl font-bold text-[#1a365d]">
        ...
        {/* CTA Agency */}
        <div className="mt-10 rounded-xl bg-gradient-to-r from-[#1a365d] to-[#1a365d]/80 p-6 text-white">
          <div className="flex flex-col items-start gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <Link
              href="/search"
              className="inline-flex shrink-0 items-center gap-2 rounded-lg bg-[#d4af37] px-5 py-2.5 text-sm font-medium text-white transition-colors hover:bg-[#d4af37]/90"
            >
              Trouver une agence
