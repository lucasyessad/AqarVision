    ...
    <div className="mx-auto max-w-3xl space-y-1">
      ...
      <div className="overflow-hidden rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 dark:border-zinc-800 dark:bg-zinc-900">
        <div className="grid grid-cols-1 gap-6 p-6 md:grid-cols-[240px_1fr]">
          ...
          <div>
            <div className="flex items-center gap-3 rounded-lg border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800 px-3 py-2.5 dark:border-zinc-800 dark:bg-zinc-900/50">
      ...
      <form action={updateProfileAction}>
        <div className="overflow-hidden rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 dark:border-zinc-800 dark:bg-zinc-900">
          ...
          <div className="grid grid-cols-1 gap-6 border-b border-zinc-200 dark:border-zinc-700 p-6 dark:border-zinc-800 md:grid-cols-[240px_1fr]">
            ...
            <div>
              <input
                ...
                className="h-10 w-full rounded-lg border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 px-3 text-sm text-zinc-950 dark:text-zinc-50 transition-shadow focus:border-amber-500 focus:outline-none focus:ring-2 focus:ring-amber-500/10 dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-50"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-6 border-b border-zinc-200 dark:border-zinc-700 p-6 dark:border-zinc-800 md:grid-cols-[240px_1fr]">
            ...
            <div>
              <select
                ...
                className="h-10 w-full rounded-lg border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 px-3 text-sm text-zinc-950 dark:text-zinc-50 focus:border-amber-500 focus:outline-none focus:ring-2 focus:ring-amber-500/10 dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-50"
              >
          ...
          {/* Footer */}
          <div className="flex items-center justify-end bg-zinc-50 dark:bg-zinc-800 px-6 py-4 dark:bg-zinc-900/50">
            <button
              type="submit"
