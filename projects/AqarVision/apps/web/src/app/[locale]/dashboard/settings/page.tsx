          ...
          <div className="grid grid-cols-1 gap-6 border-b p-6 md:grid-cols-[240px_1fr]" style={{ borderColor: "#E3E8EF" }}>
            ...
            <div>
              <input
                ...
                className="w-full rounded-md border px-3 py-2 text-sm transition-shadow focus:outline-none"
                style={{ borderColor: "#E3E8EF", color: "var(--charcoal-950)" }}
                onFocus={(e) => {
                  e.target.style.borderColor = "var(--coral)";
                  e.target.style.boxShadow = "0 0 0 3px rgba(232,114,92,0.1)";
                }}
                onBlur={(e) => {
                  e.target.style.borderColor = "#E3E8EF";
