...
const MortgageCalculator = dynamic(
  ...
  {
    loading: () => (
      <div className="h-48 animate-pulse rounded-xl border border-zinc-200 dark:border-zinc-700 bg-zinc-100 dark:bg-zinc-800 dark:border-zinc-700 dark:bg-zinc-800" />
    ),
  }
);
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-zinc-50 dark:bg-zinc-800 dark:bg-zinc-950">
        ...
        {/* -- Breadcrumb -------------------------------------------------- */}
        <div className="border-b border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800 px-4 py-3 dark:border-zinc-800 dark:bg-zinc-950">
        ...
        <div className="mx-auto grid max-w-[1200px] gap-8 px-6 py-8 lg:grid-cols-[1fr_360px]">
          ...
          <div className="min-w-0">
            ...
            {/* Editorial title */}
            <h1 className="mb-5 font-display text-2xl font-bold leading-snug text-zinc-900 dark:text-zinc-100 md:text-3xl dark:text-zinc-50">
              {listing.title}
            </h1>

            {/* Price block */}
            <div className="mb-6 inline-flex flex-col rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 px-5 py-4 dark:border-zinc-700 dark:bg-zinc-900">
              <p className="text-3xl font-bold tracking-tight text-zinc-900 dark:text-zinc-100 dark:text-zinc-50">
            ...
            <div className="mb-8 grid grid-cols-2 gap-4 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 p-5 sm:grid-cols-4 dark:border-zinc-700 dark:bg-zinc-900">
              {listing.surface_m2 !== null && (
                <div>
                  <p className="mb-1 text-xs font-medium uppercase tracking-wide text-zinc-400 dark:text-zinc-500">
                    {tListings("surface")}
                  </p>
                  <p className="text-base font-semibold text-zinc-900 dark:text-zinc-100 dark:text-zinc-50">
            ...
            {listing.description && (
              <div className="mb-8">
                <h2 className="mb-4 font-display text-xl font-bold text-zinc-900 dark:text-zinc-100 dark:text-zinc-50">
                  Description
                </h2>
            ...
            {Object.keys(listing.details).length > 0 && (
              <div className="mb-8">
                ...
                <div className="grid grid-cols-2 gap-3 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 p-5 sm:grid-cols-3 dark:border-zinc-700 dark:bg-zinc-900">
          ...
          <div className="w-full shrink-0">
            <div className="sticky top-20 space-y-4">
              ...
              {listing.owner_type === "agency" && listing.agency_slug ? (
                <div className="overflow-hidden rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 dark:border-zinc-700 dark:bg-zinc-900">
                  {/* Agency header */}
                  <div className="border-b border-zinc-200 dark:border-zinc-700 px-5 py-4 dark:border-zinc-700">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="font-display font-semibold text-zinc-900 dark:text-zinc-100 dark:text-zinc-50">
                          {listing.agency_name}
                        </h3>
                        <a
                          href={getAgencyUrl(listing.agency_slug ?? "")}
                  ...
                  <div className="space-y-3 p-5">
                    {listing.agency_phone ? (
                      <a
                        ...
                        className="flex w-full items-center justify-center gap-2 rounded-lg bg-zinc-950 px-4 py-3 text-sm font-semibold text-zinc-50 transition-opacity hover:opacity-90 dark:bg-zinc-50 dark:bg-zinc-800 dark:text-zinc-950 dark:text-zinc-50"
                      >
                    ...
                    <a
                      href={getAgencyUrl(listing.agency_slug ?? "")}
                      className="flex w-full items-center justify-center rounded-lg border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800 px-4 py-2.5 text-sm font-medium text-zinc-600 transition-colors hover:bg-zinc-100 dark:bg-zinc-800 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-300 dark:hover:bg-zinc-700"
                    >
                ...
                <div className="overflow-hidden rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 dark:border-zinc-700 dark:bg-zinc-900">
                  ...
                  <div className="border-t border-zinc-200 dark:border-zinc-700 p-5 dark:border-zinc-700">
                    <Link
                      href="/search"
                      className="flex w-full items-center justify-center rounded-lg border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800 px-4 py-2.5 text-sm font-medium text-zinc-600 transition-colors hover:bg-zinc-100 dark:bg-zinc-800 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-300 dark:hover:bg-zinc-700"
                    >
