  ...
  return (
    <>
      ...
      <button
        type="button"
        onClick={openModal}
        className="flex items-center gap-2 rounded-lg border border-[#d4af37] bg-white px-3 py-2 text-sm font-medium text-[#d4af37] transition-colors hover:bg-[#d4af37]/10"
      >
        <svg
          className="h-4 w-4"
          fill="none"
