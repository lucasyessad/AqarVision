  ...
  if (results.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <p className="mt-1 text-sm text-zinc-500">Essayez d&apos;élargir vos critères de recherche</p>
      </div>
    );
  }
      ...
      {totalPages > 1 && (
        <div className="mt-10 flex items-center justify-center gap-3">
          <button
            ...
            disabled={page <= 1}
            className="flex items-center gap-1.5 rounded-lg border border-zinc-200 bg-zinc-50 px-4 py-2 text-sm font-medium text-zinc-600 transition-colors disabled:cursor-not-allowed disabled:opacity-40"
          >
