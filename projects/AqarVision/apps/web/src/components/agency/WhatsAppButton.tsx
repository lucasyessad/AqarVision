 ...
 * WhatsAppButton
 *
 * Floating WhatsApp CTA fixed at the bottom-end of the viewport.
 * Returns null when no phone number is provided.
...
export default function WhatsAppButton({ phone, agencyName }: WhatsAppButtonProps) {
  ...
  const message = encodeURIComponent(
    `Bonjour ${agencyName}, je vous contacte depuis AqarVision`
  )
